                ...
                btnSignIn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        SharedPreferences ShredRefsign = getSharedPreferences("Login", Context.MODE_PRIVATE);
                                ...
                                String user=ShredRefsign.getString("UserName","");
                                String mot_pass=ShredRefsign.getString("Password","");

                                   if(user.toLowerCase().trim().equals(edtuser.getText().toString().toLowerCase().trim())&&mot_pass.toLowerCase().trim().equals(edtpass.getText().toString().toLowerCase().trim()))
                                   {
